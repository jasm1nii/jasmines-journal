<section aria-labelledby="webmaster-identity">
    <div class="card h-card">
        ...
        <div class="pfp-group">
            <img class="u-photo" src="<?=Media::Img?>/07042023-me_compressed.webp" width="190" height="190" alt="a self portrait of the webmaster"/>
            <div class="flower-fill">
                <img src="<?=Media::Img?>/flower.svg" width="55" height="55" alt=""/>
                <img src="<?=Media::Img?>/flower.svg" width="55" height="55" alt=""/>
                <div id="surprise">
                    <noscript>
                        <details>
                            <summary>
                                <img src="<?=Media::Img?>/flower.svg" width="55" height="55" alt="" title="open for a surprise!"/>
                            </summary>
                            <img src="<?=Media::Img?>/la-creatura.png" loading="lazy" class="u-featured" alt="ASCII art of the autism creature"/>
                        </details>
                    </noscript>
                </div>
            </div>
        ...
        <div class="p-note">
            ...
            <div class="hidden">
                ...
                <a href="https://jasm1nii.xyz/" aria-hidden="true" tabindex="-1" inert></a></span>
            </div>
        </div>
