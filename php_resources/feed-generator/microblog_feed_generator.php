<?php
    ...
    ## then, specify a pattern that matches the path of each individual page. for example, this will match /YYYY/MM/DD/entry (regardless of extension, so this includes .html and .php).
