<?php
    ...
    class RenderConfig {
        const Dir = SITE_ROOT . "/src/_helpers/";
        const Twig = self::Dir . "twig_default_config.php";
        const MarkdownComments = self::Dir  . "commonmark_comments_config.php";
        const MarkdownWithTOC = self::Dir  . "commonmark_toc_config.php";
    }
